...
def mandanga(option):
    match option:
        case 1:
            f1 = "vp8_160x120.webm"; f2 = "vp9_160x120.webm"; f3 = "h265_160x120.mp4"; f4 = "av1_160x120.mkv"
            filename = "mandanga_160x120.mkv"
        case 2:
            f1 = "vp8_360x240.webm"; f2 = "vp9_360x240.webm"; f3 = "h265_360x240.mp4"; f4 = "av1_360x240.mkv"
            filename = "mandanga_360x240.mkv"
        case 3:
            f1 = "vp8_480p.webm"; f2 = "vp9_480p.webm"; f3 = "h265_480p.mp4"; f4 = "av1_480p.mkv"
            filename = "mandanga_480p.mkv"
        case 4:
            f1 = "vp8_720p.webm"; f2 = "vp9_720p.webm"; f3 = "h265_720p.mp4"; f4 = "av1_720p.mkv"
...
i = input("Do you want to execute task1? Press y/n")
...
if (i == "y"):
    ...
    print("1. 160x120 \n"
          ...
          "3. 480p \n"
          "4. 720p \n")
    re = int(input("In which resolution you want to display the video?"))

    mandanga(re) #choose resolution 1-2-3-4
